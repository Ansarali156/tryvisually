/**
 * Multi-language Code Snippets for Sorting Algorithms
 */

export const SORTING_SNIPPETS: Record<string, Record<string, string>> = {
  "bubble-sort": {
  ...
  "merge-sort": {
    typescript: `function mergeSort(arr: number[], l = 0, r = arr.length - 1): number[] {
  if (l >= r) return arr;
